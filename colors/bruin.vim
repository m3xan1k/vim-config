...
if ($TERM =~ '256' || &t_Co >= 256) || has("gui_running")
    ...
    hi Pmenu ctermbg=black ctermfg=white cterm=NONE guibg=#000000 guifg=#ffff00 gui=NONE
    hi PmenuSbar ctermbg=NONE ctermfg=NONE cterm=NONE guibg=NONE guifg=NONE gui=NONE
    hi PmenuSel ctermbg=yellow ctermfg=black cterm=NONE guibg=#ffff00 guifg=#000000 gui=NONE
    ...
    hi JediUsage ctermbg=black ctermfg=white cterm=NONE guibg=#000000 guifg=#ffffff gui=NONE
    hi JediFunction ctermbg=black ctermfg=white cterm=NONE guibg=#000000 guifg=#ffffff gui=NONE
    hi JediFat ctermbg=black ctermfg=white cterm=NONE guibg=#000000 guifg=#ffffff gui=NONE
    hi JediSpace ctermbg=black ctermfg=white cterm=NONE guibg=#000000 guifg=#ffffff gui=NONE
